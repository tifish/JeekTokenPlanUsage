...
实现：[ClaudeUsageProvider.cs](../JeekTokenPlanUsage/ClaudeUsageProvider.cs)
...
无论响应 2xx 还是 429，这组头都会返回，所以即使被限流也能拿到数据。模型列表 [ClaudeUsageProvider.cs:21-25](../JeekTokenPlanUsage/ClaudeUsageProvider.cs#L21-L25) 是回退链，第一个能拿到 rate-limit 头就停。
...
[ClaudeUsageProvider.cs](../JeekTokenPlanUsage/ClaudeUsageProvider.cs)
...
[TrayApplicationContext.cs](../JeekTokenPlanUsage/TrayApplicationContext.cs) 控制：
